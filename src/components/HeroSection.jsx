...
const HeroSection = () => {
  return (
    <header className="relative -z-10 min-h-screen flex items-center justify-center overflow-hidden bg-slate-50 dark:bg-[#0B0F19] transition-colors duration-300" name="beranda">
      ...
      <div className="container relative z-10 px-6 pt-36 pb-24 lg:pt-44 lg:pb-20 mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-6 xl:gap-10 items-center">
          ...
          <div className="flex justify-center relative order-1 lg:order-2 w-full lg:col-span-5">
            ...
            <div className="relative w-72 sm:w-96 lg:w-full max-w-[460px] aspect-[4/5]">
              ...
              {/* Profile Image (No wrapper box) */}
              <img
                className="relative w-full h-full object-cover rounded-[3.5rem] transition-all duration-500 hover:-translate-y-2 hover:scale-[1.02] shadow-2xl"
                src={imagePoster}
                alt="Jufron Tamo Ama"
                loading="eager"
              />
